...
public class CameraController : MonoBehaviour
{
	...
	void Update()
	{
		...
		if(following)
		{
            ...
            transform.position = cameraTarget.transform.position + offset / 3;
            ...
            /*transform.position = new Vector3(Mathf.Lerp(lastPosition.x, cameraTarget.transform.position.x + offset.x, /*smoothing * Time.deltaTime),
                Mathf.Lerp(lastPosition.y, cameraTarget.transform.position.y + offset.y, Time.deltaTime),// smoothing * Time.deltaTime), 
            Mathf.Lerp(lastPosition.z, cameraTarget.transform.position.z + offset.z, Time.deltaTime));//smoothing * Time.deltaTime));*/
